...
const { mFormRef, mModel, mLoading, counterState, counter, mLogin, mRules, sendCode } = useMobileLogin()
</script>
...
<template>
  <BlankLayout>
    <div
      flex="~ col"
      class="py-20px items-center justify-center"
    >
